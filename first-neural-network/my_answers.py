...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        hidden_outputs = self.activation_function(np.dot(hidden_inputs, weights_input2hidden)) # signals from hidden layer
        ...
        final_outputs = np.dot(hidden_outputs, weights_hidden2output) # signals from final output layer
